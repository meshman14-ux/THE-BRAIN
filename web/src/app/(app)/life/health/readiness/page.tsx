 ...
 * display model, here and on `/life/health` and `/life/health/train` — the
  ...
  return (
    <div className="grid gap-5 max-w-[820px]">
      ...
      <p style={{ textAlign: "center", fontSize: "0.74rem" }}>
        <Link href="/life/health/train" style={{ color: "var(--hud-cyan)", textDecoration: "none", fontWeight: 700 }}>
          ← Today&apos;s session
        </Link>
        {"  ·  "}
        <Link href="/life/health" style={{ color: "var(--hud-cyan)", textDecoration: "none", fontWeight: 700 }}>
          Home
        </Link>
      </p>
    </div>
