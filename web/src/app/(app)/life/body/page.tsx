      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }}>
          ...
          <div className="mono" style={{ fontSize: 11, display: "flex", gap: 16 }}>
            <Link href="/life/body/readiness" style={{ color: "var(--hud-cyan)", textDecoration: "none" }}>
              CONTRIBUTOR BREAKDOWN ▸
            </Link>
            <Link href="/life/body/food" style={{ color: "var(--hud-cyan)", textDecoration: "none" }}>
              FOOD ▸
            </Link>
          </div>
        </div>
        ...
        <div className="grid gap-4">
          ...
          <HudPanel serial="MSN.221" title="TODAY&rsquo;S MISSION">
            ...
            <Link href="/life/body/train" className="btn" style={{ textDecoration: "none", display: "inline-block" }}>
              [ ENGAGE ]
            </Link>
          </HudPanel>
        </div>
